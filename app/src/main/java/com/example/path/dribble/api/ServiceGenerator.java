...
import com.example.path.dribble.BuildConfig;
...
public class ServiceGenerator {
    ...
    public static final String API_BASE_URL = "https://dribbble.com";
    public static final String DRIBBLE_API="https://api.dribbble.com/v1/";
